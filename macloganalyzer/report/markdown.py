...
def _header(lines: list, ctx: SystemContext, now: datetime) -> None:
    ...
    lines += [
        ...
        f"| Tool Version | SentinelOne macOS Log Analyzer 1.2.2 |",
        "",
        "---",
        "",
...
def _blind_spots(lines: list, ctx: SystemContext) -> None:
    ...
    lines += ["", "---", ""]
    lines.append("*Report generated by [SentinelOne macOS Log Analyzer 1.2.2](https://github.com/Flor1an-B/sentinelone-macos-log-analyzer)*")
