...
def _nav(findings: list[Finding], by_sev: dict[str, int], ctx: "SystemContext | None" = None) -> str:
    ...
    return (
        ...
        f'<p style="font-size:10px;color:rgba(255,255,255,.25);margin-top:3px">by Florian Bertaux · v1.2.0</p>'
        f'</div>'
...
def generate_html(
    ...
    doc = (
        ...
        f'<p>Generated by <strong>SentinelOne macOS Log Analyzer 1.2.0</strong>'
        f' &nbsp;·&nbsp; Florian Bertaux'
